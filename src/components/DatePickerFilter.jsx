  ...
  return (
    <div className="filter-container__right">
      <DatePicker 
        ...
        value={date.start}
        disabledDate={(dateValue) => isDateBefore(date.end, dateValue) || disableDateFromTommorow(dateValue)}
      /><div className="dash"/>
      <DatePicker 
        oneTap 
        cleanable={false}
        ...
        value={date.end}
        disabledDate={(dateValue) => isDateBefore(dateValue, date.start) || disableDateFromTommorow(dateValue)}
      />
    </div>
  )
}